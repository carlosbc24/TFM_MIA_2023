...
class_HSVE_path = './DATASETS/Dataset_Model8/HSVE_ORIGINAL_ONLY_AXIAL_T1_FLAIR_T2_RESCALED_256/' # Ubicación remota las imágenes MRI de la clase positiva (cerebros con la enfermedad HSVE)
...
class_HealthyBrains_path = './DATASETS/Dataset_Model8/HEALTHY_BRAINS_ONLY_AXIAL_T1_FLAIR_T2_RESCALED_256/' # Ubicación remota las imágenes MRI de la clase negativa (cerebros sanos)
...
plot_model(base_model, to_file='arquitecturas_modelos/Model8Iteration2_baseModel_ResNet50.png', show_shapes=True)
...
with tf.device('/GPU:0'):
    ...
    # Save the model defined previously
    plot_model(model_gpu, to_file='arquitecturas_modelos/Model8Iteration2_ResNet50_TransferLearning_ONLY_AXIAL_T1_FLAIR_T2_DATASET_arquitecture.png', show_shapes=True)
...
df.to_csv('classification_reports/Model8Iteration2_ResNet50_TransferLearning_ONLY_AXIAL_T1_FLAIR_T2_DATASET_classification_report.csv', index=True)
...
fig.savefig('figuras/Model8Iteration2_ResNet50_TransferLearning_ONLY_AXIAL_T1_FLAIR_T2_DATASET_confusion_matrix.png')
...
fig.savefig('figuras/Model8Iteration2_ResNet50_TransferLearning_ONLY_AXIAL_T1_FLAIR_T2_DATASET_accuracy_vs_loss.png')
...
fig = figure.get_figure()
fig.savefig('figuras/Model8Iteration2_ResNet50_TransferLearning_ONLY_AXIAL_T1_FLAIR_T2_DATASET_accuracy.png')
...
fig = figure.get_figure()
fig.savefig('figuras/Model8Iteration2_ResNet50_TransferLearning_ONLY_AXIAL_T1_FLAIR_T2_DATASET_loss.png')
...
# activations.savefig('figuras/Model8Iteration2_ResNet50_TransferLearning_ONLY_AXIAL_T1_FLAIR_T2_DATASET_20_activations')
...
np.save('modelos_entrenados/Model8Iteration2_ResNet50_TransferLearning_ONLY_AXIAL_T1_FLAIR_T2_DATASET_HSVE_vs_Healthy_ResNet50_HISTORY.npy',h.history)
...
model_gpu.save('modelos_entrenados/Model8Iteration2_ResNet50_TransferLearning_ONLY_AXIAL_T1_FLAIR_T2_DATASET_HSVE_vs_Healthy_ResNet50.h5')
