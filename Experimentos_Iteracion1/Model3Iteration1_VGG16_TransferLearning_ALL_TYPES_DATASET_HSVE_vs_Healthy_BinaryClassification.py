...
# # 6. DEFINICIÓN Y CONFIGURACIÓN DEL MODELO DE CNN (Red Neuronal Convolucional) con Transfer Learning del modelo VGG16

# In[ ]:


# Instantiate a ResNet50 model with pre-trained weights
base_model = k.applications.VGG16(weights='imagenet', include_top=False)
...
plot_model(base_model, to_file='arquitecturas_modelos/Model3Iteration1_baseModel_VGG16.png', show_shapes=True)
...
with tf.device('/GPU:0'):
    ...
    # Save the model defined previously
    plot_model(model_gpu, to_file='arquitecturas_modelos/Model3Iteration1_VGG16_TransferLearning_ALL_TYPES_DATASET_arquitecture.png', show_shapes=True)
...
df.to_csv('classification_reports/Model3Iteration1_VGG16_TransferLearning_ALL_TYPES_DATASET_classification_report.csv', index=True)
...
fig.savefig('figuras/Model3Iteration1_VGG16_TransferLearning_ALL_TYPES_DATASET_confusion_matrix.png')
...
fig.savefig('figuras/Model3Iteration1_VGG16_TransferLearning_ALL_TYPES_DATASET_accuracy_vs_loss.png')
...
fig = figure.get_figure()
fig.savefig('figuras/Model3Iteration1_VGG16_TransferLearning_ALL_TYPES_DATASET_accuracy.png')
...
fig = figure.get_figure()
fig.savefig('figuras/Model3Iteration1_VGG16_TransferLearning_ALL_TYPES_DATASET_loss.png')
...
# activations.savefig('figuras/Model3Iteration1_VGG16_TransferLearning_ALL_TYPES_DATASET_20_activations')
...
np.save('modelos_entrenados/Model3Iteration1_VGG16_TransferLearning_ALL_TYPES_DATASET_HSVE_vs_Healthy_HISTORY.npy',h.history)
...
model_gpu.save('modelos_entrenados/Model3Iteration1_VGG16_TransferLearning_ALL_TYPES_DATASET_HSVE_vs_Healthy.h5')
